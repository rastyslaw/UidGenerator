...
namespace UidGenerator
{
    ...
    {
        private const uint SanityCountToMatch = 4585239;
        private const uint TopCount = 100;
        
        private static readonly FileInfo InputFile =  new FileInfo(@$"{Path.Combine(Directory.GetCurrentDirectory(), "plot.list")}");
        ...
        public ParallelTest()
        {
            ...
            // words = GetTopWordsSequentialOld();
        ...
        private static IDictionary<string, uint> GetTopWordsSequentialOld()
        {
